...
The output is a wide data set that summarisesmean and standard deviation measurements of the combined train and test data sets for accelerometer readings from the Samsung Galaxy S smartphone. The mean of each measurements subject and activity is include in the output file
